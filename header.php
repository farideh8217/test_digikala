...
<body style="margin: 0;background: #<=php body_color ?>;">
        ...
        <div id="header_right" style="width: 720px;float: right;height: 100px;">
            <div id="header_right_top" style="height: 40px;">
                ...
                <php  } else { ?>
                    ...
                    <span
                        style="width: 20px;height: 20px;background: url(public/images/signup.png);display: block;float: right;margin-right: 20px;"></span>
                    <a class="yekan fontsm" href="<=php URL ?>panel" style="float: right;margin-right: 10px;">

                        مشاهده پنل کاربری
                    </a>

                    <a class="yekan fontsm" href="<=php URL ?>panel/logout" style="float: right;margin-right: 10px;">
            ...
            <div id="header_right_bottom" style="height: 50px;">
                <div id="basket_top" style="width: 190px;height: 40px;float: right;">
                    ...
                    <a href="showcart" id="basket_top_left"
                        ...
                        <span class="fontsm"
                              style="width: 25px;height: 25px;background: #eee;text-align: center;display: block;float: left;margin-top: 7px;border-radius: 100%;line-height: 25px;" id="basketTotal"><=php $all ?></span>
                            ...
                            <li data-time="<=php $level2['id'] ?>">
                                ...
                                <div class="submenu3"
                                    ...
                                    <ul style="padding-right: 10px;" class="top_menu3_col top_menu3_col_ul">
                                        ...
                                        <li class="level3 yekan fontsm"><=php $level3['title']; ?></li>
                                    ...
                                    <ul style="padding-right: 10px;" class="top_menu3_col top_menu3_col_ul">
                                        ...
                                        <li class="yekan fontsm"><=php $level4['title'] ?></li>
                                        <php 
                                        $i++;
                                        }//level4
