...
افزودن آدرس جدید
    ...
    <div class="content">
        ...
        foreach ($address as $row) {
            ...
            <table data-id="<=php $row['id']; ?>" data-city="<=php $row['city']; ?>" class="table_address <php  if($first==1){echo 'active';} ?>" cellspacing="0">
                <tr>

                    <td onclick="sessionAddress(<=php $row['id'] ?>)" class="select_address"
                    ...
                    <td style="width: 34px;padding: 0;" rowspan="3">
                        ...
                        <table cellspacing="0">
                            <tr>
                                <td onclick="editAddress(<=php $row['id'] ?>)" class="edit"
                                    style="border: 0;cursor: pointer;"><i></i></td>
                            </tr>
                            <tr>
                                <td onclick="deleteAddress(<=php $row['id'] ?>)" class="remove" style="border: 0;cursor: pointer;"><i></i></td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td style="width: 200px;font-size: 10pt;">استان: <=php $row['ostan_name']; ?></td>
                    <td rowspan="2" style="font-size: 10.5pt;color: #858889;">

                        <br>
                        کدپستی:<=php $row['codeposti']; ?>
                    </td>
                    <td style="width: 200px;font-size: 10.5pt;">
                        شماره تماس اضطراری:<=php $row['mobile']; ?>
                    </td>

                </tr>
                <tr>
                    <td style="width: 200px;font-size: 10pt;">
                        شهر:<=php $row['city_name']; ?>
                    </td>
                    <td style="width: 200px;font-size: 10.5pt;">
                        شماره تماس ثابت:<=php $row['tel']; ?>
                    </td>
                </tr>
            </table>
    ...
    <div class="send_types">
        ...
        foreach ($postType as $row) {
            ...
            <table data-post-type="<=php $row['id'] ?>" class="table_post" cellspacing="0">
                <tr>
                    ...
                    <td>
                        ...
                        <p style="margin: 1px 0;font-size: 12pt;color: green;text-align: center;">
                            <span id="post_price<=php $row['id']; ?>"></span>
                            تومان
                        </p>
                    </td>
                </tr>
