...
<div id="main" style="width: 1200px;margin:10px auto;padding: 5px;background: #fff;">
    ...
    <form method="post" action="addcomment/savecomment/<=php $productInfo['id'] ?>">

        <div class="right">
            <img src="public/images/products/<=php $productInfo['id'] ?>/product_350.jpg">
        </div>
            ...
            <div class="right">
                ...
                foreach ($params_right as $row) {
                    ...
                    <div class="row2">
                        ...
                        <input data-val="<=php $comment_result[$row['id']] ?>" name="param<=php $row['id'] ?>"
                               value="<=php $comment_result[$row['id']] ?>" type="hidden" class="flat-slider">
                    </div>
                <php  } ?>
        ...
        <div class="comment">
            ...
            <div class="row2">
                <input name="title" value="<=php $commentInfo['title'] ?>" placeholder="عنوان نقد و بررسی">
            </div>
            <div class="row2">
                <input name="posotive" value="<=php $commentInfo['posotive'] ?>" placeholder="نقاط قوت">
            </div>
            <div class="row2">
                <input name="negative" value="<=php $commentInfo['negative'] ?>" placeholder="نقاط ضعف">
            </div>

            <div class="row2">
                <textarea name="comment"><=php $commentInfo['matn'] ?></textarea>
            </div>
            <div class="row2">
