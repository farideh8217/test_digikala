...
<div id="sidebar">
    ...
    <ul class="filter_ul">
        ...
        <li class="title"><=php $attr['title'] ?></li>
        <php 
        ...
        foreach ($attrValues as $val) {
            ...
            <li>
                ...
                <input name="attr-<=php $attr['id'] ?>[]" value="<=php $val['id'] ?>" class="check_input" type="checkbox">
<=php $val['val'] ?>
            </li>
        <php  } ?>
    </ul>
    ...
    <ul class="filter_ul">
        ...
        <li>
            <label class="check_label"></label>
            <input name="colorSelected[]" value="<=php $row['id'] ?>" class="check_input" type="checkbox">
            <span class="product_color" style="background-color: <=php $row['hex'] ?>;"></span>
<=php $row['title'] ?>
        </li>
