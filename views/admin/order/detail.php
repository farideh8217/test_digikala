<style>
    ...
    <form method="post" action="adminorder/editOrder/<=php $orderInfo['id'] ?>">
        ...
        <h4>
            ...
            <a href="adminorder/showfactor/<=php $orderInfo['id'] ?>" class="btn_green"
...
وضعیت سفارش:
                ...
                <select name="order_status">
                    ...
                    ?>
                    <option value="<=php $status['id'] ?>" <php  if($orderInfo['status'] == $status['id']){echo 'selected="selected"';} ?>>
<=php $status['title'] ?>
                    </option>
...
شیوه پرداخت:
        ...
        <table id="addressinfo" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td>
                    <input name="address" type="text" value="<=php $orderInfo['address']; ?>">
                </td>
                <td>
                    <=php $orderInfo['city']; ?>
                </td>
                <td>
                    ...
                    <input name="code_posti" type="text" value="<=php $orderInfo['code_posti']; ?>">
                </td>
                <td>
                ...
                <td>
                    ...
                    <input name="tel" type="text" value="<=php $orderInfo['tel']; ?>">
                </td>
            </tr>
