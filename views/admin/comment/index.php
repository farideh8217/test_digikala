        ...
        <table class="list" cellspacing="0">
            ...
            foreach ($comments as $row) {
                ...
                <tr>
                    ...
                    <td>
                        <input name="title<=php $row['id'] ?>" value="<=php $row['title']; ?>">

                    </td>
                    <td>
                        <input name="posotive<=php $row['id'] ?>" value="<=php $row['posotive']; ?>">

                    </td>
                    <td>
                        <input name="negative<=php $row['id'] ?>" value="<=php $row['negative']; ?>">

                    </td>
                    <td>
                        <textarea name="matn<=php $row['id'] ?>"><=php $row['matn']; ?></textarea>
                    </td>
