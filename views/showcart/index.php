...
<=php $row['tedad'] ?>
                            ...
                            <ul>
                                <php  for ($i = 1; $i < 31; $i++) { ?>
                                    ...
                                    <li onclick="updateBasket(<=php $i ?>,<=php $row['basketRow'] ?>)"><=php $i ?></li>
                    ...
                    <td style="cursor: pointer;" class="remove_td" onclick="removeBasket(<=php $row['basketRow'] ?>)">
...
<script>
    ...
    function createBasketList(basket,priceTotalall) {
        ...
        $.each(basket, function (index, value) {
            ...
            var trTag = '<tr><td><div class="right"><img src="public/images/products/' +id+ '/product_220.jpg"></div><div class="left"><p>' + title + '</p><p>'+color+'</p><p>'+garantee+'</p></div></td><td><div class="selectlist"><span class="yekan zamanattitle">' + tedad + '</span><ul><php  for ($i = 1; $i < 31; $i++) { ?><li onclick="updateBasket(<=php $i ?>,'+basketRow+')"><=php $i ?></li><php  } ?></ul></div></td><td><span class="price">' + price + '</span><span class="tuman">تومان</span></td><td><span class="price">' + price*tedad + '</span><span class="tuman">تومان</span></td><td class="remove_td" onclick="removeBasket(' + basketRow + ')"><i class="remove_icon"></i></td></tr>';
