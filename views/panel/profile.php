...
<div id="main">
    ...
    <form method="post" action="panel/editprofile">
        ...
        <span class="title">
            ...
            <input type="text" name="email" value="<=php $profile['email'] ?>">
...
نام و نام خانوادگی:
            ...
            <input type="text" name="family" value="<=php $profile['family'] ?>">
...
کد ملی:
            ...
            <input type="text" name="code_meli" value="<=php $profile['code_meli'] ?>">
...
شماره تلفن ثابت:
            ...
            <input type="text" name="tel" value="<=php $profile['tel'] ?>">
...
شماره همراه:
            ...
            <input type="text" name="mobile" value="<=php $profile['mobile'] ?>">
...
روز:
            ...
            <select name="day">
                ...
                for ($i = 1; $i < 32; $i++) {
                    ?>
                    <option value="<=php $i ?>" <php  if ($i == $day) {
...
ماه:
            ...
            <select name="month">
                ...
                for ($i = 1; $i < 13; $i++) {
                    ?>
                    <option value="<=php $i ?>" <php  if ($i == $month) {
                        echo 'selected="selected"';
                    } ?>>
                        <=php $i ?>
                    </option>
...
سال:
            ...
            <select name="year">
                ...
                for ($i = 1310; $i <= Model::jaliliDate('Y'); $i++) {
                    ?>
                    <option value="<=php $i ?>" <php  if ($i == $year) {
                        echo 'selected="selected"';
                    } ?>>
                        <=php $i ?>
                    </option>
...
محل سکونت:
            ...
            <input type="text" name="address" style="width: 350px;" value="<=php $profile['address'] ?>">
