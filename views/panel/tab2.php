    ...
    <table cellspacing="0">
        ...
        foreach ($order as $row) {
            ...
            <tr>
                ...
                <td><=php $row['id'] ?></td>
                <td><=php $row['date'] ?></td>
                <td style="font-family: tahoma;"><=php number_format($row['amount']) ?></td>
                <td><=php $row['title'] ?></td>
                <td>
                    <a href="checkout/index/<=php $row['id'] ?>">
                        پرداخت
                    </a>
                </td>
                <td>سفارش</td>
                    ...
                    <div class="subtable">
                        ...
                        <table cellspacing="0">
                            ...
                            foreach ($basket as $row2) {
                                ...
                                ?>
                                <tr>
                                    <td><=php $row2['title'] ?></td>
                                    <td><=php $row2['tedad'] ?></td>
                                    <td><=php $row2['price'] ?></td>
                                    <td><=php $price_all ?></td>
                                    <td><=php $discount_amount ?></td>
